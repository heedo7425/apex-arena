...
export const META: Record<string, Meta> = {
  ...
  'std.pursuitCurv':{label:'Pursuit curvature',cat:'Control',desc:'목표점에 도달하려면 필요한 회전 곡률 k를 계산 (2·y/거리²).'},
  'std.steerFromCurv':{label:'Steer from curv',cat:'Control',desc:'곡률 k를 조향 명령(−1~1)으로 변환. gain으로 세기 조절.'},
