...
export type RFNode = { id:string; type:'apex'; position:{x:number;y:number}; data:{ coreType:string; params:Record<string,any>; label?:string; outputLabels?:Record<string,string>; liveOverride?:any } }
