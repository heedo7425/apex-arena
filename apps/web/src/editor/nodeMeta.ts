...
export const PALETTE_CATS: {cat:string; types:string[]}[] = [
  ...
  {cat:'Struct',   types:['pose.parts','wpt.parts','state.parts','command.make']},
  ...
  {cat:'Trajectory', types:['trajectory.rollout','trajectory.parts','trajectory.clearance','trajectory.progress','trajectory.collides','trajectories.empty','trajectories.append','trajectories.selectMin']},
